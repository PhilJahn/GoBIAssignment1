...
public class ExonSkipOld implements Interval{
	...
	public ExonSkipOld(ArrayList<String> sv_prot, ArrayList<Region> introns, ArrayList<String> wt_prot, ArrayList<Transcript> sv_trans, ArrayList<Transcript> wt_trans) {
...
//		maxBase = minBase;
	...
	public void merge(ExonSkipOld e){
		if(start < stop){
...
//		wt_introns = introns;
	...
	public boolean mergeable(ExonSkipOld es) {
